...
data_both_variability_final <- tribble(
  ...
  "arithmetic", "coefficient of variation (%CV)", "percentage ($\\text{%}$)", "relative measure of spread around the AM. used for normally distributed data.",
  # --- GEOMETRIC MEASURES ---
  ...
  "geometric", "geometric coefficient of variation (%GCV)", "percentage ($\\text{%}$)", "relative symmetrical scatter around the geometric mean (GM). preferred for log-normal data."
)
